      ...
      <section id="projects" className="bg-background py-28 md:py-32" data-testid="featured-projects-section">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            <motion.div className="group overflow-hidden rounded-2xl border border-[rgba(107,30,50,0.14)] bg-[rgba(248,245,240,0.85)] backdrop-blur-md shadow-clay shadow-[inset_0_1px_1.5px_0_rgba(255,255,255,0.9),0_18px_45px_-12px_rgba(69,19,35,0.08)] transition-all duration-500 hover:-translate-y-1 hover:shadow-clay-hover hover:border-primary/30" data-testid="project-card-0" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
            ...
            <motion.div className="group overflow-hidden rounded-2xl border border-[rgba(107,30,50,0.14)] bg-[rgba(248,245,240,0.85)] backdrop-blur-md shadow-clay shadow-[inset_0_1px_1.5px_0_rgba(255,255,255,0.9),0_18px_45px_-12px_rgba(69,19,35,0.08)] transition-all duration-500 hover:-translate-y-1 hover:shadow-clay-hover hover:border-primary/30" data-testid="project-card-1" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              <div className="relative aspect-[16/9] overflow-hidden">
            ...
            <motion.div className="group overflow-hidden rounded-2xl border border-[rgba(107,30,50,0.14)] bg-[rgba(248,245,240,0.85)] backdrop-blur-md shadow-clay shadow-[inset_0_1px_1.5px_0_rgba(255,255,255,0.9),0_18px_45px_-12px_rgba(69,19,35,0.08)] transition-all duration-500 hover:-translate-y-1 hover:shadow-clay-hover hover:border-primary/30" data-testid="project-card-2" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              <div className="relative aspect-[16/9] overflow-hidden">
            ...
            <motion.div className="group overflow-hidden rounded-2xl border border-[rgba(107,30,50,0.14)] bg-[rgba(248,245,240,0.85)] backdrop-blur-md shadow-clay shadow-[inset_0_1px_1.5px_0_rgba(255,255,255,0.9),0_18px_45px_-12px_rgba(69,19,35,0.08)] transition-all duration-500 hover:-translate-y-1 hover:shadow-clay-hover hover:border-primary/30" data-testid="project-card-3" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              <div className="relative aspect-[16/9] overflow-hidden">
            ...
            <motion.div className="group overflow-hidden rounded-2xl border border-[rgba(107,30,50,0.14)] bg-[rgba(248,245,240,0.85)] backdrop-blur-md shadow-clay shadow-[inset_0_1px_1.5px_0_rgba(255,255,255,0.9),0_18px_45px_-12px_rgba(69,19,35,0.08)] transition-all duration-500 hover:-translate-y-1 hover:shadow-clay-hover hover:border-primary/30" data-testid="project-card-4" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              <div className="relative aspect-[16/9] overflow-hidden">
            ...
            <motion.div className="group overflow-hidden rounded-2xl border border-[rgba(107,30,50,0.14)] bg-[rgba(248,245,240,0.85)] backdrop-blur-md shadow-clay shadow-[inset_0_1px_1.5px_0_rgba(255,255,255,0.9),0_18px_45px_-12px_rgba(69,19,35,0.08)] transition-all duration-500 hover:-translate-y-1 hover:shadow-clay-hover hover:border-primary/30" data-testid="project-card-5" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              <div className="relative aspect-[16/9] overflow-hidden">
