...
import { ArrowRight, ArrowUpRight, BadgeCheck, BellRing, Blocks, BookOpenCheck, Bot, Braces, Building2, CalendarClock, ChartColumn, ChevronRight, CircleCheck, ClipboardList, Clock4, Cog, Download, FilePenLine, FileSearch, Fingerprint, Gauge, GitBranch, Globe, Handshake, Headphones, Instagram, KeyRound, Languages, Layers, LayoutTemplate, Lock, Mail, MailCheck, MapPin, MessageCircle, MessageCircleQuestionMark, MessageSquareQuote, MessagesSquare, Phone, PhoneCall, Plug, Quote, ReceiptIndianRupee, Rocket, Send, ShieldCheck, ShoppingBag, Smartphone, Sparkles, Star, Stethoscope, Target, Timer, TrendingUp, Truck, Undo2, UserCheck, Users, WandSparkles, Workflow } from 'lucide-react';
...
export function AiChatbotsContent() {
  return (
      <main className="flex-grow">
        <section className="relative overflow-hidden bg-background pb-16 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="container relative z-10 mx-auto px-6 md:px-12">
            ...
            <motion.h1 className="mb-6 max-w-4xl font-serif text-[clamp(2.9rem,6.2vw,5.6rem)] font-semibold leading-[0.92] text-foreground" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              Custom AI agents that answer,
              <span className="block text-primary">
                decide, and get the job done.
              </span>
            </motion.h1>
            <motion.p className="mb-9 max-w-2xl text-lg leading-8 text-secondary-foreground" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              Built to your requirements, trained on your material, and connected to your systems — running on WhatsApp, your website, Instagram, phone calls, and your team's internal chat from one shared brain.
            </motion.p>
            <motion.div className="flex flex-col flex-wrap gap-3 sm:flex-row" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              ...
              <a href="#omnichannel" className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-card/60 px-7 py-3.5 text-sm font-semibold text-foreground backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-foreground hover:bg-card md:text-base">
                See the channels
              </a>
            </motion.div>
          </div>
        ...
        <section id="omnichannel" className="relative overflow-hidden border-y border-border bg-muted/50 py-24 md:py-28" data-testid="omnichannel-section">
          ...
          <div className="container relative z-10 mx-auto px-6 md:px-12">
            <div className="mb-14 grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-end">
              ...
              <motion.p className="max-w-xl text-lg leading-8 text-secondary-foreground" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                Build the assistant once. It carries the same knowledge, tone, and history to WhatsApp, your website, Instagram, phone calls, and your team's internal chat — so a customer never has to repeat themselves.
              </motion.p>
            </div>
            <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:gap-8">
              <motion.div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-primary/45 bg-card shadow-clay lg:-translate-y-1" data-testid="omnichannel-whatsapp" aria-pressed="true">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(31, 143, 82)', transform: 'scaleX(1)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(31, 143, 82, 0.1)', color: 'rgb(31, 143, 82)' }}>
                ...
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-border bg-card/55 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-sm" data-testid="omnichannel-instagram" aria-pressed="false">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(193, 53, 132)', transform: 'scaleX(0)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(193, 53, 132, 0.1)', color: 'rgb(193, 53, 132)' }}>
                ...
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-border bg-card/55 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-sm" data-testid="omnichannel-messenger" aria-pressed="false">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(0, 132, 255)', transform: 'scaleX(0)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(0, 132, 255, 0.1)', color: 'rgb(0, 132, 255)' }}>
                ...
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-border bg-card/55 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-sm" data-testid="omnichannel-telegram" aria-pressed="false">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(42, 171, 238)', transform: 'scaleX(0)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(42, 171, 238, 0.1)', color: 'rgb(42, 171, 238)' }}>
                ...
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-border bg-card/55 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-sm" data-testid="omnichannel-mobile" aria-pressed="false">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(38, 70, 57)', transform: 'scaleX(0)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(38, 70, 57, 0.1)', color: 'rgb(38, 70, 57)' }}>
                ...
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-border bg-card/55 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-sm" data-testid="omnichannel-voice" aria-pressed="false">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(139, 92, 246)', transform: 'scaleX(0)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(139, 92, 246, 0.1)', color: 'rgb(139, 92, 246)' }}>
                ...
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-border bg-card/55 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-sm" data-testid="omnichannel-landing" aria-pressed="false">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(224, 160, 48)', transform: 'scaleX(0)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(224, 160, 48, 0.1)', color: 'rgb(224, 160, 48)' }}>
                ...
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-border bg-card/55 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-sm" data-testid="omnichannel-email" aria-pressed="false">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(176, 67, 42)', transform: 'scaleX(0)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(176, 67, 42, 0.1)', color: 'rgb(176, 67, 42)' }}>
                ...
                <button type="button" className="group relative overflow-hidden rounded-2xl border p-5 text-left transition-all duration-300 border-border bg-card/55 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-sm" data-testid="omnichannel-teams" aria-pressed="false">
                  <span className="absolute inset-x-0 top-0 h-[3px] origin-left transition-transform duration-300" style={{ background: 'rgb(74, 95, 193)', transform: 'scaleX(0)' }} />
                  <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl transition-colors" style={{ backgroundColor: 'rgba(74, 95, 193, 0.1)', color: 'rgb(74, 95, 193)' }}>
              ...
              <motion.div className="lg:sticky lg:top-28 lg:self-start" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-clay">
                  <div className="flex items-center gap-3 px-5 py-4" style={{ background: 'linear-gradient(120deg, rgb(31, 143, 82), rgba(31, 143, 82, 0.8))' }}>
                  ...
                  <div className="min-h-[290px] space-y-3 bg-[linear-gradient(180deg,_rgba(0,0,0,0.02),_transparent)] p-5">
                    <motion.div className="flex justify-start" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                      <span className="max-w-[85%] rounded-2xl px-4 py-2.5 text-sm leading-6 shadow-sm rounded-bl-sm border border-border bg-background text-foreground">
                        Hi Rahul 👋 Your order #4821 shipped this morning.
                      </span>
                    </motion.div>
                    <motion.div className="flex justify-end" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                      <span className="max-w-[85%] rounded-2xl px-4 py-2.5 text-sm leading-6 shadow-sm rounded-br-sm bg-foreground text-background">
                        When will it reach me?
                      </span>
                    </motion.div>
                    <motion.div className="flex justify-start" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                      <span className="max-w-[85%] rounded-2xl px-4 py-2.5 text-sm leading-6 shadow-sm rounded-bl-sm border border-border bg-background text-foreground">
                        Tomorrow before 6 PM. Want the live tracking link?
                      </span>
                    </motion.div>
                    <motion.div className="flex justify-end" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                      <span className="max-w-[85%] rounded-2xl px-4 py-2.5 text-sm leading-6 shadow-sm rounded-br-sm bg-foreground text-background">
                  ...
                  <div className="border-t border-border bg-background/70 px-5 py-5">
                    ...
                    <p className="mt-2 text-sm leading-6 text-secondary-foreground">
                      Orders, tracking, payments, and support inside the app your customers already use every day.
                    </p>
                    <div className="mt-4 flex flex-wrap gap-2">
                      <span className="rounded-full border border-border bg-muted px-3 py-1.5 text-xs font-medium text-secondary-foreground">
                        Order updates
                      </span>
                      <span className="rounded-full border border-border bg-muted px-3 py-1.5 text-xs font-medium text-secondary-foreground">
                        Payment links
        ...
        <section className="bg-background py-24 md:py-28">
          <div className="container mx-auto px-6 md:px-12">
            <div className="mb-14 max-w-3xl">
              ...
              <motion.h2 className="font-serif text-5xl font-semibold leading-[0.96] text-foreground md:text-6xl" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                The same agent, shaped to your industry.
              </motion.h2>
            </div>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <motion.div className="group rounded-2xl border border-border bg-card/60 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-clay" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                <ShoppingBag className="mb-4 text-secondary-foreground transition-colors group-hover:text-primary" aria-hidden="true" />
                <h3 className="mb-2 font-heading text-lg font-semibold text-foreground">
                  Retail &amp; E-commerce
                </h3>
                <p className="text-sm leading-6 text-secondary-foreground">
                  Answers product and delivery questions, shares payment links, and recovers abandoned carts.
                </p>
              </motion.div>
              <motion.div className="group rounded-2xl border border-border bg-card/60 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-clay" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                <Stethoscope className="mb-4 text-secondary-foreground transition-colors group-hover:text-primary" aria-hidden="true" />
                <h3 className="mb-2 font-heading text-lg font-semibold text-foreground">
                  Healthcare
                </h3>
                <p className="text-sm leading-6 text-secondary-foreground">
                  Books and reschedules appointments, sends reminders, and collects intake details before a visit.
                </p>
              </motion.div>
              <motion.div className="group rounded-2xl border border-border bg-card/60 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-clay" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                <Truck className="mb-4 text-secondary-foreground transition-colors group-hover:text-primary" aria-hidden="true" />
                <h3 className="mb-2 font-heading text-lg font-semibold text-foreground">
                  Logistics
                </h3>
                <p className="text-sm leading-6 text-secondary-foreground">
                  Gives live shipment status, captures delivery exceptions, and routes escalations to the right desk.
                </p>
              </motion.div>
              <motion.div className="group rounded-2xl border border-border bg-card/60 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-clay" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                <Building2 className="lucide-building-2 mb-4 text-secondary-foreground transition-colors group-hover:text-primary" aria-hidden="true" />
                <h3 className="mb-2 font-heading text-lg font-semibold text-foreground">
                  Real Estate
                </h3>
                <p className="text-sm leading-6 text-secondary-foreground">
                  Qualifies enquiries, shares matching listings, and books site visits straight into an agent calendar.
                </p>
              </motion.div>
              <motion.div className="group rounded-2xl border border-border bg-card/60 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-clay" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                <Headphones className="mb-4 text-secondary-foreground transition-colors group-hover:text-primary" aria-hidden="true" />
                <h3 className="mb-2 font-heading text-lg font-semibold text-foreground">
                  Services &amp; B2B
                </h3>
                <p className="text-sm leading-6 text-secondary-foreground">
                  Handles tier-one support, raises tickets, and hands complex cases to a human with full context.
                </p>
              </motion.div>
              <motion.div className="group rounded-2xl border border-border bg-card/60 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-card hover:shadow-clay" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                <Bot className="mb-4 text-secondary-foreground transition-colors group-hover:text-primary" aria-hidden="true" />
                <h3 className="mb-2 font-heading text-lg font-semibold text-foreground">
                  Internal teams
                </h3>
                <p className="text-sm leading-6 text-secondary-foreground">
                  Answers policy, stock, and reporting questions for staff inside Slack, Teams, or WhatsApp.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="mb-14 grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-end">
              <div>
                ...
                <motion.h2 className="font-serif text-5xl font-semibold leading-[0.96] text-foreground md:text-6xl" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                  What our agents changed.
                </motion.h2>
              </div>
              <motion.p className="max-w-xl text-lg leading-8 text-secondary-foreground" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                Chatbot and automation projects, and the number each one moved.
              </motion.p>
            </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
              <div className="lg:sticky lg:top-28 lg:self-start">
                ...
                <motion.h2 className="mb-5 font-serif text-4xl font-semibold leading-[0.98] text-foreground md:text-5xl" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                  Chatbot questions, answered plainly.
                </motion.h2>
                <motion.p className="mb-8 max-w-md text-base leading-7 text-secondary-foreground" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-50px' }} transition={{ duration: 0.6, ease: 'easeOut' }}>
                  What businesses ask us before putting an AI agent in front of their customers.
                </motion.p>
